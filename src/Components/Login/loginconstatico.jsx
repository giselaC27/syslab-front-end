...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Validación de usuario utilizando datos estáticos
    const staticUser = {
    ...
    if (email === staticUser.email && password === staticUser.password) {
      // Si los datos ingresados coinciden con los datos estáticos, se llama a la función onLogin
      onLogin();
    } else {
      // Si los datos no coinciden, se muestra el modal de error
      setShowModal(true);
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-cover bg-center">
      ...
      {showModal && (
        <div className="fixed inset-0 flex items-center justify-center z-10">
          ...
          <div className="bg-white rounded-lg p-6 w-96 shadow-lg z-20">
