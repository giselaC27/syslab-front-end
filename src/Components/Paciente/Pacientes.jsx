...
const Pacientes = () => {
  ...
  const [editInstitution, setEditInstitution] = useState({
    id: '', descripcion: '', codigoDependencia: '',
    activo: true,
  });
  ...
  const [newTipoPaciente, setNewTipoPaciente] = useState({
    id: '',
    descripcion: '',
    codigoTipoPaciente: '',
    activo: true,
  ...
  const [editEmpresa, setEditEmpresa] = useState({
    id: '', descripcion: '', codigoEmpresa: '',
    activo: true,
  });
  const [editTipoPaciente, setEditTipoPaciente] = useState({
    id: '', descripcion: '', codigoTipoPaciente: '',
    activo: true,
  });
  ...
  const handleInstitutionSubmit = async (e) => {
    ...
    if (newInstitution.descripcion.trim() !== '' && newInstitution.codigoDependencia.trim() !== '') {
      try {
        ...
        setError('Codigo ya existente, prueba uno diferente ');
        setIsLoading(false);
      } finally {
        setIsLoading(false);
      }
    ...
    <div className="p-8 w-full">
      ...
      <div className="flex items-center space-x-4 mb-6">
        ...
        <input
          ...
          placeholder="Buscar un paciente por su CI, nombre, apellidos, Tipo paciente, Empresa o Dependencia"
        />
            ...
            <tbody>
              {tiposPacientes.map((tipoPaciente, index) => (
                <tr key={index} className="bg-white border-b border-gray-200">
                  <td className="px-4 py-2">{tipoPaciente.codigoTipoPaciente}</td>
              ...
              <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody>
                  {institutions.map((institution, index) => (
                    <tr key={index} className="bg-white border-b border-gray-200">
                      <td className="px-4 py-2">{institution.codigoDependencia}</td>
              ...
              <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody>
                  {empresas.map((empresa, index) => (
                    <tr key={index} className="bg-white border-b border-gray-200">
                      <td className="px-4 py-2">{empresa.codigoEmpresa}</td>
      ...
      {isInstitutionModalOpen && (
        <div className="fixed inset-0 overflow-y-auto bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-md mx-auto">
            <h2 className="text-2xl font-bold mb-4">Dependencia</h2>
      ...
      {isEditInstitutionModalOpen && (
        <div className="fixed inset-0 overflow-y-auto bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-8 rounded-lg shadow-lg max-w-md mx-auto">
            <h2 className="text-2xl font-bold mb-4">Editar Depedencia</h2>
